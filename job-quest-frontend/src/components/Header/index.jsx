...
const Header = () => {
  ...
  const userData = useSelector((state) => state.auth.userData);  // Getting the userData
      ...
      <nav className="flex justify-between items-center">
        ...
        {isAuthenticated ? (
          <div className="flex items-center gap-x-6 2xl:gap-x-8">
            <span className="text-white font-semibold text-lg">{userData?.name}{isRecruiter?' (Recruiter)':' (Candidate)'} </span>  {/* Displaying user name */}
            <button
